...
In this vignette, I will describe how to read and summarize data from `disease.sh-Open Disease Data API`. I will create several functions to access and retrieve data that I am interested in from APIs. I will also demonstrate how to conduct analysis using some of R packages. 
